...
quantity*cost_to_customer_per_qty as price
FROM customer_purchases
WHERE vendor_id BETWEEN 8 --1937
AND 10 --0
;
...
, customer_last_name
,ROUND(SUM(CAST(quantity AS decimal(5,2))*cost_to_customer_per_qty),2) as total_spend
